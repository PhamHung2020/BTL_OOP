...
namespace DAL
{
    public class KhachHangDAL
    {
        ...
        public void Load()
        {
            ...
            {
                new KhachHangDTO("00001", "Pham Hung", "Lang Son", "TC101", new DateTime(2021, 3, 15), new DateTime(2021, 5, 15), 10000000),
                new KhachHangDTO("TC20520210120 ", "Nguyen Van A", "Ha Noi", "TC205", new DateTime(2021, 1, 20), new DateTime(2021, 5, 20), 7000000),
                new KhachHangDTO("TC10420210113 ", "Nguyen Van B", "Ha Noi", "TC104", new DateTime(2021, 1, 13), new DateTime(2021, 5, 12), 10000000),
                new KhachHangDTO("TC30420210201 ", "Nguyen Van C", "Ha Noi", "TC304", new DateTime(2021, 2, 1), new DateTime(2021, 5, 15), 11000000),
